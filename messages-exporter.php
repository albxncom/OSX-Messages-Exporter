...
<html>
	<head>
		...
		img { max-width: 100%; }
		.message { overflow:hidden; text-align: left; color: black; border-radius: 8px; background-color: #e1e1e1; padding: 6px; display: inline-block; max-width: 75%; margin-bottom: 5px; float: left; }
